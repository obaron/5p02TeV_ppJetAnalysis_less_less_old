...
#define R__DICTIONARY_FILENAME dIusersdIh2dIobarondI5p02TeV_ppJetAnalysisdICMSSW_7_5_8dIsrcdIRooUnfoldmIsvnTrunkdItmpdIlinuxx8664gccdIRooUnfoldDict
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::RooUnfoldIds*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("RooUnfoldIds", ::RooUnfoldIds::Class_Version(), "RooUnfoldIds.h", 18,
                  typeid(::RooUnfoldIds), DefineBehavior(ptr, ptr),
...
{
   if (!fgIsA) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::RooUnfoldIds*)0x0)->GetClass(); }
   return fgIsA;
}
...
"/users/h2/obaron/5p02TeV_ppJetAnalysis/CMSSW_7_5_8/src/RooUnfold-svnTrunk/src/",
"/users/h2/obaron/5p02TeV_ppJetAnalysis/CMSSW_7_5_8/src/RooUnfold-svnTrunk",
"/cvmfs/cms.cern.ch/slc6_amd64_gcc491/lcg/root/6.02.12/include",
"/users/h2/obaron/5p02TeV_ppJetAnalysis/CMSSW_7_5_8/src/RooUnfold-svnTrunk/",
0
    };
...
class __attribute__((annotate(R"ATTRDUMP(Data unfolding using Singular Value Decomposition (hep-ph/9509307))ATTRDUMP"))) __attribute__((annotate("$clingAutoload$src/RooUnfoldSvd.h")))  TSVDUnfold_130729;
)DICTFWDDCLS";
